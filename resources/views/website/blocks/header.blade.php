    ...
    <div class="navbar">
        <div class="container">
            <div class="navbar-header">
                <div class='navbar-brand Module'><a class="logo" title="Online Manga" href="/">CommicBuddy</a></div>
                <div class="navbar-form navbar-left hidden-xs search-box">
                    <form action="{{route('genre')}}" method="Get">
                        <div class="input-group">
                            <input type="text" name="keyword" class="search-comic form-control"
            ...
            <ul class="nav-account list-inline hidden-xs pull-right">
                ...
                <li class="dropdown"><a data-toggle="dropdown" class="user-menu fn-userbox dropdown-toggle"
                        ...
                        <span>Your Account</span> <i class="fa fa-caret-down"></i></a>
                    <ul class="dropdown-menu">
                        <li><a rel="nofollow" class="user-profile-link-desktop" href="{{route('general')}}"><i
                                    class="fa fa-user"></i>
                ...
                @else
                <li class="login-link">
                    <a rel="nofollow" href="{{route('login')}}">Login</a>
                </li>
                <li class="register-link">
                    <a rel="nofollow" href="{{route('register')}}">Register</a>
                </li>
                @endif
            </ul>
        </div>
